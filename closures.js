...
function callFriend(name) {
  function dial(valueber) {
    return 'Calling ' + name + ' at ' + valueber
  }
  return dial;
}
// Do not edit the code above.
...
/*
  Here we have a function named secretvalueber that has a secret valueber.
  Inside the return object, create two methods called addToSecret and takeAwayFromSecret.
  addToSecret should have a parameter that is added to the secret valueber returning the updated secret valueber.
  takeAwayFromSecret should have a parameter that takes away from the secret valueber returning the updated secret valueber.
*/
